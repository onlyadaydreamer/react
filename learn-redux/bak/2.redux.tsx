...
let counterValue: HTMLParagraphElement = document.getElementById('counter-value') as HTMLParagraphElement;
let incrementBtn: HTMLButtonElement = document.getElementById('increment') as HTMLButtonElement;
let decrementBtn: HTMLButtonElement = document.getElementById('decrement') as HTMLButtonElement;
...
const reducer: Reducer<State, CounterAction> = (state: State = initialState, action: CounterAction): State => {
    switch (action.type) {
        case INCREMENT:
