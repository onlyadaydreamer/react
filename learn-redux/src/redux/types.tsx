// 任何的Action都必须有一个属性type type的类型就是 T=any（默认any）
...
// IMP: 特别强调 dispatch方法返回值 就是派发的动作action
 ...
 */
//Required type parameters may not follow optional type parameters. 必选的参数不能跟在可选的参数后面, 所以A extends Action<any>不能有默认值， 因为如果A不传的话，那参数对应关系就错了。
